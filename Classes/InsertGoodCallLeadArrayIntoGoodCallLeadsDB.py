...
class InsertGoodCallLeadArrayIntoGoodCallLeadsDB(object):
    def __init__(self, goodCallLeadArray):
        ...
        if not self.checkIfAlreadyInDatabase():
            ...
            self.db.insertUpdateOrDelete("update dbo.GoodCallLeads set Name=N'" + self.name + "', Url=N'" + self.url + "', NumAwards=N'" + self.numAwards + "', Amount=N'" + self.amount + "', Description=N'" + self.description + "', Sponsor=N'" + self.sponsor + "', ClassStatus=N'" + self.classStatus + "', Major=N'" + self.major + "', Gender=N'" + self.gender + "', Ethnicity=N'" + self.ethnicity + "', Grades=N'" + self.grades + "', TestScores=N'" + self.testScores + "', Deadline=N'" + self.deadline + "', EssayInfo=N'" + self.essayInfo + "', SourceWebsite=N'" + self.sourceWebsite + "', SourceText=N'" + self.sourceText + "'")
