...
States = ['Alabama', 'Alaska', 'Arizona', 'Arkansas', 'California', 'Colorado', 'Connecticut', 'Delaware', 'Florida',
    ...
    'West Viriginia', 'Wisconsin', 'Wyoming', 'AL', 'AK', 'AZ', 'AR', 'CA', 'CO', 'CT', 'DE', 'FL', 'GA', 'HI', 'ID', 'IL',
...
MajorUSCities = ['New York City', 'Los Angeles', 'Chicago', 'Houston', 'Philadelphia', 'Phoenix', 'San Antonio',
    'San Diego', 'Dallas', 'San Jose', 'Austin', 'Jacksonville', 'San Francisco', 'Indianapolis', 'Columbus', 'Fort Worth',
    'Charolotte', 'Detroit', 'El Paso', 'Seattle', 'Denver', 'Washington', 'Memphis', 'Boston', 'Nashville', 'Baltimore',
    'Oklahoma City', 'Portland', 'Las Vegas', 'Louisville', 'Milwaukee', 'Albuquerque', 'Tucson', 'Fresno', 'Sacramento',
    'Long Beach', 'Kansas City', 'Mesa', 'Atlanta', 'Virginia Beach', 'Omaha', 'Colorado Springs', 'Raleigh', 'Miami',
    'Oakland', 'Minneapolis', 'Tulsa', 'Cleveland', 'Wichita', 'New Orleans', 'Arlington', 'Bakersfield', 'Tampa', 'Aurora',
    'Honolulu', 'Anaheim', 'Santa Ana', 'Corpus Christi', 'Riverside', 'St. Louis', 'Lexington', 'Pittsburgh', 'Stockton',
    'Anchorage', 'Cincinnati', 'Saint Paul', 'Greensboro', 'Toledo', 'Newark', 'Plano', 'Henderson', 'Lincoln', 'Orlando',
    'Jersey City', 'Chula Vista', 'Buffalo', 'Fort Wayne', 'Chandler', 'St. Petersburg', 'Laredo', 'Durham', 'Irvine',
    'Madison', 'Norfolk', 'Lubbock', 'Gilbert', 'Winston-Salem', 'Reno', 'Hialeah', 'Garland', 'Chesapeake', 'Irving',
    'Scottsdale', 'Baton Rouge', 'Fremont', 'Richmond', 'Boise', 'San Bernardino', 'Birmingham', 'Spokane', 'Rochester',
    'Modesto', 'Des Moines', 'Oxnard', 'Tacoma', 'Fontana', 'Fayetteville', 'Moreno Valley', 'Columbus', 'Huntington Beach',
    'Yonkers', 'Montgomery', 'Aurora', 'Glendale', 'Shreveport', 'Akron', 'Little Rock', 'Amarillo', 'Augusta', 'Mobile',
    'Grand Rapids', 'Salt Lake City', 'Huntsville', 'Tallahassee', 'Grand Prairie', 'Overland Park', 'Knoxville',
    'Brownsville', 'Worchester', 'Newport News', 'Santa Clarita', 'Providence', 'Fort Lauderdale', 'Garden Grove',
    'Oceanside', 'Rancho Cucamonga', 'Santa Rosa', 'Port St. Lucie', 'Chattanooga', 'Tempe', 'Jackson', 'Cape Coral',
    'Vancouver', 'Ontario', 'Sioux Falls', 'Peoria', 'Springfield', 'Pembroke Pines', 'Elk Grove', 'Salem', 'Lancaster',
    'Eugene', 'Palmdale', 'McKinney', 'Salinas', 'Fort Collins', 'Cary', 'Hayward', 'Pasadena', 'Macon', 'Pomona',
    'Alexandria', 'Escondido', 'Sunnyvale', 'Lakewood', 'Kansas City', 'Rockford', 'Torrance', 'Hollywood', 'Joliet',
    'Bridgeport', 'Clarksville', 'Patterson', 'Naperville', 'Frisco', 'Mesquite', 'Savannah', 'Syracuse', 'Dayton',
    'Pasadena', 'Orange', 'Fullerton', 'McAllen', 'Kileen', 'Hampton', 'Bellevue', 'Warren', 'Miramar', 'West Valley City',
    'Olathe', 'Columbia', 'Sterling Heights', 'Thornton', 'New Haven', 'Waco', 'Charleston', 'Thousand Oaks', 'Visalia',
    'Cedar Rapids', 'Elizabeth', 'Roseville', 'Gainesville', 'Corrollton', 'Stamford', 'Denton', 'Midland', 'Coral Springs',
    'Concord', 'Topeka', 'Simi Valley', 'Surprise', 'Lafayette', 'Kent', 'Hartford', 'Santa Clara', 'Victorville',
    'Abilene', 'Murfreesboro', 'Evansville', 'Vallejo', 'Athens', 'Allentown', 'Berkeley', 'Norman', 'Ann Arbor',
    'Beaumont', 'Independence', 'El Monte', 'Fargo', 'Lansing', 'Odessa', 'Downey', 'Wilmington', 'Arvana', 'Costa Mesa',
    'Round Rock', 'Carlsbad', 'Miami Gardens', 'Westminster', 'Inglewood', 'Rochester', 'Fairfield', 'Elgin', 'West Jordan',
    'Clearwater', 'Manchester', 'Lowell', 'Gresham', 'Cambridge', 'Ventura', 'Temecula', 'Waterbury', 'Antioch', 'Billings',
    'High Point', 'Richardson', 'West Covina', 'Pueblo', 'Murrieta', 'Centennial', 'Nowalk', 'Charleston', 'Everett',
    'Pompano Beach', 'Daly City', 'Palm Bay', 'Burbank', 'Wichita Falls', 'Boulder', 'Green Bay', 'Broken Arrow',
    'West Palm Beach', 'College Station', 'Pearland', 'Santa Maria', 'El Cajon', 'San Mateo', 'Lewisville', 'Rialto',
...
Countries = ['U.S.', 'US', 'United States', 'China', 'Japan', 'Germany', 'United Kingdom', 'France', 'Brazil', 'Italy',
    'India', 'Russia', 'Canada', 'Australia', 'South Korea', 'Spain', 'Mexico', 'Indonesia', 'Netherlands', 'Turkey',
    'Saudi Arabia', 'Switzerland']

Nationalities = ['American', 'Chinese', 'Japanese', 'German', 'British', 'French', 'Brazilian', 'Italian', 'Indian',
    'Russian', 'Canadian', 'Australian', 'South Korean', 'Spanish', 'Mexican', 'Indonesian', 'Dutch', 'Turkish',
    'Saudi Arabian', 'Swiss']
...
ListInterestsandActivities = ['accounting', 'agricultural/food science', 'agricultural science', 'food science', 'life science',
    'anatomy & physiology', 'anatomy and physiology', 'anthropology', 'architecture', 'arid lands', 'athletics',
    'atmospheric science', 'audiology', 'automotive engineering', 'aviation', 'behavioral science', 'bike racing',
    'biomedical engineering', 'business', 'business administration', 'chemistry', 'communications', 'community service',
    'computer science', 'conservation', 'construction', 'counseling', 'criminal justice', 'cultures', 'heiritage',
    'ecology', 'economics', 'education', 'electronic media', 'broadcasting', 'engineering', 'english', 'entrepreneurship',
    'environment', 'epidemiological studies', 'film', 'finance', 'fine arts', 'flexography', 'food service', 'foreign language',
    'gender studies', 'geology', 'golf', 'government', 'graphic communications', 'health and safety', 'history', 'horiculture',
    'hotel management', 'humanities', 'hvac', 'hydrology', 'information resources', 'information technology', 'instrumentation',
    'automation', 'international studies', 'journalism', 'landscape', 'languages', 'law', 'liberal arts', 'library science',
    'linguistics', 'livestock', 'material science', 'management', 'management information systems', 'marine science', 'marketing',
    'medicine', 'metallurgy', 'microbiology', 'middle eastern language', 'mining', 'music', 'natural resources', 'nuclear studies',
    'nursing', 'oceanic science', 'press', 'psychology', 'public administration', 'public education', 'mathematics', 'math',
    'social and behavioral science', 'sociology', 'study abroad', 'race', 'ethnicity', 'radiology', 'real estate', 'religion',
    'technical broadcasting', 'technology', 'veterinary science', 'water skiing', 'education', 'teaching', 'art', 'entomology',
    'nutritional sciences', 'chemical engineering', 'civil engineering', 'computer engineering', 'electrical engineering',
    'engineering management', 'geological engineering', 'industrial engineering', 'mechanical engineering', 'non-destructive testing',
    'optical science', 'welding', 'dance', 'media arts', 'theatre', 'classics', 'pharmacy', 'public health', 'biochemistry',
    'biology', 'solid waste management', 'achaeology', 'aerospace', 'transportation', 'outdoor recreation', 'physical therapy',
    'amateur radio', 'philosophy','palynology', 'football', 'interior design', 'intellectual property law', 'zoology',
    'enology', 'viticulture', 'taekwondo', 'print communications', 'public speaking', 'archery', 'baseball', 'hospitality',
    'travel', 'softball', 'bowling', 'equestrian', 'rodeo', 'respiratory care', 'research', 'fire science', 'biostatistics',
    'operations management', 'paralegal', 'astronomy', 'national security', 'counterintelligence', 'creative writing',
    'foreign service', 'explosives', 'plastics', 'polymers', 'visual arts', 'dairy industry', 'meteorology', 'insulators',
    'physics', 'cross-country', 'track and field', 'basketball', 'swimming', 'veterans affairs', 'fashion', 'social justice',
    'graphic arts', 'design', 'disabilities', 'retail', 'latin', 'greek', 'translation', 'interpretation', 'game development',
    'religious mission', 'cosmetology', 'fishing', 'neuroscience', 'triathelete', 'beef', 'meat industry', 'ultilities',
    'microelectronics', 'african american studies', 'optometry', 'neonatal', 'judaic studies', 'chiropractic care',
    'laser', 'light based therapy', 'running', 'marathon', 'acoustics', 'robotics', 'soccer', 'phonetics', 'speech production',
    'water resources', 'hispanic culture', 'botany', 'scottish culture', 'insurance',  'cross country', 'utilities',
    'community involvement', 'school activity', 'patriotism', 'religious organization', 'mechanics', 'heritage conservation']
...
ClassStandingOptions = ['high school senior', 'freshman', 'sophomore', 'junior', 'senior', 'masters level graduate',
    'ph.d. level graduate', 'non-degree seeking graduate', 'law school student', 'medical school student', 'nursing school student',
...
MajorOptions = ['aerospace engineering', 'accounting', 'anthropology', 'arts', 'business management', '\schemistry',
    'chemical engineering', 'civil engineering', 'communication', 'computing & software systems', 'computer engineering',
    'computer science', 'ecology', 'economics', 'electrical engineering', 'engineering', 'english',
    'environmental engineering', 'environmental sciences', 'entrepreneurship', 'finance', 'geology', 'history',
    'human resource management', 'hydrogeology', 'hydrology', 'information science', 'information systems',
    'information systems technology management', 'electrical engineering', 'journalism', 'laser optics', 'library science',
    'linguistics', 'marketing', 'mathematics', 'mechanical engineering', 'medicine', 'metallurgy', 'mining', 'nursing',
    'physics', 'political science', 'psychology', 'science', 'science technology', 'social sciences', 'sociology',
    'agricultural & biosystems engineering', 'biosystems engineering', 'bio systems engineering', 'software systems',
    ...
    'business economics', 'classics', 'creative writing', 'criminal justice administration', 'dance', 'dramatic theory',
    'earth science', 'east asian studies', 'elementary education', 'engineering mathematics', 'engineering physics',
    'family and consumer sciences education', 'family studies', 'fine and performing arts', 'fine arts studies', 'french',
    'business administration', 'geography', 'geological engineering', 'geosciences', 'german studies', 'greek',
    'health education', 'health & human service administration', 'health and human service administration',
    'computing and software systems', 'agricultural and biosystems engineering', 'agricultural and resource economics',
    'humanities', 'judaic studies', 'latin american studies', 'liberal studies', 'materials science and engineering',
    'media arts', 'medical technology', 'mexican american studies', 'microbiology', 'mining engineering',
    'molecular & cellular biology', 'molecular and cellular biology', 'music', 'music education', 'musical theatre',
    'natural sciences and mathematics', 'geography and regional development', 'religious studies', 'russian',
    'secondary education', 'soil & water science', 'soil and water science', 'spanish', 'special education & rehabilitation',
    'special education and rehabilitation', 'speech & hearing sciences', 'speech and hearing sciences', 'studio art',
    'systems and industrial engineering', 'undecided/no major', 'undecided', 'no major', 'veterinary science', 'wildlife',
    'watershed & rangeland resources', 'watershed and rangeland resources', "women's studies", 'technology',
    'public administration', 'biomedical engineering', 'nuclear engineering', 'ppel', 'politics, philosophy, economics & law',
    'natural resources', 'landscape architecture', 'public health', 'visual communication', 'biology',
    'retail and consumer sciences', 'latin', 'criminal justice studies', 'criminal justice', 'italian', 'neuroscience',
    'entomology', 'agronomy', 'math', 'law', 'forestry', 'pharmacy', 'agriculture', 'enligsh', 'foreign language', 'studio art',
    'special education', 'early childhood education', 'teaching', 'literacy', 'counseling', 'education', 'studio art',
    'plant science', 'portuguese', 'japanese', 'horticulture', 'nutritional science', 'animal science', 'retail',
    'family and consumer resources', 'family and consumer science']

MajorOptions = list(set(MajorOptions))

Demographics = ['American Indian', 'Alaskan Native', 'Alaska Native', 'Asian American', 'African American', 'Black', 'Hispanic', 'Latino',
    'Native Hawaiian', 'Pacific Islander', 'White', 'Caucasian', 'Other', 'Middle Eastern', 'Mexican American', 'Native American',
...
ListAboutMeAttributes = ['adopted', 'foster child', 'orphan', 'cancer survivor', 'medical condition', 'diability',
    'domestic abuse victim', 'first generation student', 'homeless', 'non-traditional student', 'online education degree',
    'parent', 'guardian', 'student athlete', 'vegetarian', 'vegan', 'lgbtq', 'straight ally', 'immigrant', 'migrant worker',
    'single parent', 'head of household', 'financial need', 'low income', 'incoming transfer student', 'transfer student',
    'animal rights', 'business owner', 'trade school', 'wheelchair', 'disabled', '9/11', 'community college transfer',
    'marching band', 'student council', 'victim of crime', 'financial aid', 'has a child']

UAColleges = ['agriculture & life sciences', 'agriculture and life sciences', 'architecture, planning & landscape architecture',
    'architecture planning and landscape architecture', 'education', 'engineering', 'fine arts', 'humanities', 'medicine',
    'nursing', 'optical science', 'pharmacy', 'science', 'social and behavioral science', 'letters, arts and science',
    'management', 'eller', 'honors', 'law', 'james e. rogers', 'public health', 'outreach college', 'graduate college',
    'school of art', 'landscape architecture']

AttributesPlusIDs = {'GPA':[1, 364], 'Standing':[21], 'Majors':[5, 417], 'SAT Score':[8], 'High School State':[14],
    'High School City':[13], 'Required Units':[19], 'High School Arizona County':[22], 'Residency State':[35],
    'Gender':[43], 'Citizenship':[49], 'Ethnicity':[137], 'Residency Arizona County':[163], 'FAFSA':[169],
    'Enrollment Status':[171], 'Employment Status':[198], 'Interests and Activities':[229], 'About Me':[237],
    'UA College':[377, 418]}
...
def InsertIntoTestTable():
    cursor.execute("SELECT TOP 1310 * FROM dbo.DepartmentTestCases ORDER BY AttributeId")
...
def GetClassStanding(IndividualEligibility):
    ...
    FindNotGradStudentKeywords = re.search('graduate\sfrom|\sgraduates', IndividualEligibility.lower())
    ...
    FindMedicalKeywords = re.search(r'medical|medicine', IndividualEligibility.lower())
    if FindMedicalKeywords:
        FindNotMedicalSchoolKeywords = re.search(r'upper\-division|upper\sdivision|undergraduate', IndividualEligibility.lower())
...
def GetMajor(IndividualEligibility):
    ...
    SpecializedEngineeringMajors = ['aerospace engineering', 'chemical engineering', 'computer engineering', 'electrical engineering',
        'environmental engineering', 'biosystems engineering', 'bio systems engineering', 'geological engineering', 'mining engineering',
...
def GetRequiredResidencyState(IndividualEligibility):
    ...
    if FindResidency:
        for State in States:
            FindState = re.search(State, IndividualEligibility)
            if FindState:
...
def GetInterestsandActivities(IndividualEligibility):
    ...
    FindInterestKeywords = re.search(r'interest|activity|career|hobby|achievement|demonstrate|involve|activities|commit', IndividualEligibility.lower())
...
for Eligibility in Eligibilities:
    ...
    for IndividualEligibility in IndividualEligibilities:
        ...
        #if GetCollegeGraduationYear(IndividualEligibility) is not None:
        #    CollegeGraduationYear = GetCollegeGraduationYear(IndividualEligibility)
    ...
    if GPA != '': print('GPA:', GPA)
    if Standing != '': print('Standing:', Standing)
    if Majors != '': print('Majors:', Majors)
    if SATScore != '': print('SAT Score:', SATScore)
    if HighSchoolState != '': print('State of High School:', HighSchoolState)
    #print('College Graduation Year:', CollegeGraduationYear)
    if HighSchoolCity != '': print('High School City:', HighSchoolCity)
    if RequiredUnits != '': print('Required Units:', RequiredUnits)
    if HighSchoolArizonaCounty != '': print('Arizona County of High School:', HighSchoolArizonaCounty)
    if RequiredResidencyState != '': print('State of Residence:', RequiredResidencyState)
    if RequiredGender != '': print('Required Gender:', RequiredGender)
    if Citizenship != '': print('Citizenship:', Citizenship)
    if Ethnicity != '': print('Ethnicity:', Ethnicity)
    if ResidencyArizonaCounty != '': print('Arizona County of Residence:', ResidencyArizonaCounty)
    if NeedFAFSA != '': print('FAFSA Required:', NeedFAFSA)
    if EnrollmentStatus != '': print('Required Enrollment:', EnrollmentStatus)
    if EmploymentStatus != '': print('Required Employment:', EmploymentStatus)
    if InterestsandActivities != '': print('Interests and Activities:', InterestsandActivities)
    if AboutMeAttributes != '': print('About Me Attributes:', AboutMeAttributes)
    if RequiredUACollege != '': print('UA College:', RequiredUACollege)
    if RelevantYear != '': print('Relevant Year:', RelevantYear)
    if OnlineDegreeRequirement != '': print('Online Degree Program:', OnlineDegreeRequirement)
