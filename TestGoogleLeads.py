...
class TestStringMethods(unittest.TestCase):
    def test_GoogleLeads(self):
        testgoogleleadsarray = GoogleLeads('engineering scholarships').processSearchResultsAndReturnArrayOfGoogleLeads()
    ...
    def test_GoogleLeadsElseStatement(self):
        testgoogleleadsuneventhangs = GoogleLeads('engineering').processSearchResultsAndReturnArrayOfGoogleLeads()
